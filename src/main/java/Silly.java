...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param name_1 the first part of the name for this Silly instance's name.
     * @param name_2 the second part of the name for this Silly instance's name.
     */
    public Silly(String name_1, String name_2) { this.name = name_1 + name_2; }
